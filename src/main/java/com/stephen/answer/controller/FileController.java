...
import com.stephen.answer.model.enums.FileUploadBizEnum;
...
public class FileController {
	...
	public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
		...
		// todo: 修改文件上床的路径
		String filepath = String.format("/%s/%s/%s/%s", "answer", fileUploadBizEnum.getValue(), loginUser.getId(), filename);
		File file = null;
		try {
			// 上传文件
