...
import com.stephen.popcorn.model.dto.userAnswer.UserAnswerAddRequest;
import com.stephen.popcorn.model.dto.userAnswer.UserAnswerEditRequest;
import com.stephen.popcorn.model.dto.userAnswer.UserAnswerQueryRequest;
import com.stephen.popcorn.model.dto.userAnswer.UserAnswerUpdateRequest;
import com.stephen.popcorn.model.entity.App;
import com.stephen.popcorn.model.entity.User;
import com.stephen.popcorn.model.entity.UserAnswer;
import com.stephen.popcorn.model.vo.UserAnswerVO;
import com.stephen.popcorn.scoring.ScoringStrategyExecutor;
...
public class UserAnswerController {
	 ...
	 * 创建用户答案
	 *
	 * @param userAnswerAddRequest userAnswerAddRequset
	 ...
	 * 更新用户答案（仅管理员可用）
	 *
	 * @param userAnswerUpdateRequest userAnswerUpdateRequest
	 * @return BaseResponse<Boolean>
	 */
	@PostMapping("/update")
	 ...
	 *
	 * @param id id
	 * @return BaseResponse<UserAnswerVO>
	 */
	@GetMapping("/get/vo")
	 ...
	 * 分页获取当前登录用户创建的用户答案列表
	 *
	 * @param userAnswerQueryRequest userAnswerQueryRequest
	 * @param request                request
	 * @return BaseResponse<Page < UserAnswerVO>>
	 */
	 ...
	 * 编辑用户答案（给用户使用）
	 *
	 * @param userAnswerEditRequest userAnswerEditRequest
	 * @param request               request
	 * @return BaseResponse<Boolean>
	 */
	@PostMapping("/edit")
